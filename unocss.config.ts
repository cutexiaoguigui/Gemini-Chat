...
export default defineConfig({
  ...
  shortcuts: [{
    ...
    'gen-slate-btn': 'h-12 px-4 py-2 bg-(slate op-15) hover:bg-op-20 rounded-sm w-30 inline-fcc',
    'gen-slate-btn-2': 'h-12 px-4 py-2 bg-(slate op-15) hover:bg-op-20 rounded-sm',
